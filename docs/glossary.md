...
The administrative side of an Omeka S installation. This is visible to logged-in users of the [main five user types](admin/users.md) (not to people leaving comments on the public sites, etc.). The [administrative dashboard](admin-dashboard.md) is explained in further detail on its dedicated page.
