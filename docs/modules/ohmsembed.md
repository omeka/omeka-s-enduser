...
The [OHMS Embed module](https://omeka.org/s/modules/OhmsEmbed/) allows site administrators to add [Oral History Metadata Synchonizer](https://www.oralhistoryonline.org/) objects as media to Omeka S items.
...
To create OHMS packages with your interviews, you must use the OHMS application available on the [OHMS website](https://www.oralhistoryonline.org/), which requires requesting a free account and working with the web-based application. 
