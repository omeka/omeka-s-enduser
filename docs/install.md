...
- PHP, minimum version 8.1, with the following extensions installed:
	...
	- [mbstring](https://www.php.net/manual/en/book.mbstring.php){target=_blank}, and
...
- Optional, to create thumbnails: one of the following:
	- ImageMagick, minimum version 6.7.5
