...
![User settings for Omeka Dev with default options selected](/adminfiles/users_settings)
...
![Empty password reset fields for the user Omeka Devs](/adminfiles/users_password.png)
