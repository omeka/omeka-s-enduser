...
Omeka S is a web publication system for universities, galleries, libraries, archives, and museums. It creates a local network of independently curated sites or exhibits, sharing a collaboratively built pool of materials and their metadata. Collections can contain a large number of, and a wide variety of, media or text. 
