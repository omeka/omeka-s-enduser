...
Once you have registered for an account, visit the [Omeka S project page](https://explore.transifex.com/omeka/omeka-s/){target=_blank} and click on the "join this project" button.
