...
![Main view of vocabularies, with columns for label, prefix, classes, and properties counts and information]({{site.url}}{{site.baseurl}}/content/contentfiles/vocabularies.png)
