...
You can use the Navigation link in the left sidebar to manage the navigation, or menu, of your site. You can add or delete links, browse pages, and your [pages](site_pages.md) to the navigation, as well as arrange and nest them. 

Themes present your navigation links in different ways. You can modify navigation settings under [Theme settings](site_theme.md#edit-theme-settings), such as the depth of nested links to display. Be sure to refresh and check your public pages. This ensures the navigation is working correctly after you make changes.

![Editing navigation with a drawer on the right side of the screen for adding links](sitesfiles/sitenav_main.png)

For every item in the navigation, you have three options. You can view (box with arrow icon), edit (pencil icon), or delete (trash can icon). Parent navigation pages also have a gray square with a black triangle. This collapses or expands their child pages.
...
You can set the homepage without changing the order of your pages. To do this, use the **Select a homepage** section in the right-hand drawer. This section has a dropdown which lists all the pages in your site. Simply select the page you want to use as your homepage.

![Select a homepage dropdown open to show all the pages in this site](sitesfiles/sitenav_homeselect.png)

To change which page is the homepage, select a different page from the dropdown. Click the "X" to the right of the page name in the menu to revert to using the top page in the navigation.
...
The **Custom URL** link option, when added to your navigation, have three fields.  The fields are link **type** (showing as "Custom URL"), **label** (the text that will appear in the site navigation menu), and **URL**. You can also select whether the link will open a new browser window or tab when clicked.
...
Click the "Edit" button to reveal the advanced search interface in the drawer. Once you are satisfied with the results of your search, clicking the "Apply" button will set the pool of items for the Browse page.

![Advanced search query drawer](sitesfiles/sitenav_query_search.png)

Once a query has been set, you can click "Edit" to update the pool of items. You can click "Advanced edit" to edit the query string. You can "Clear" a query to start over. If you have cleared a search in error, you can "Restore" it. 

![Browse page form with the edit query element](sitesfiles/sitenav_query_update.png)

You can change the **label** of the link to reflect what site visitors will browse. For example, imagine you wish to provide separate links for users to browse images or documents. To do this, you would set the query to the appropriate classes and change the labels to indicate "Browse images" or "Browse documents".
...
When you add a link it is automatically expanded to show its options. To collapse an open link entry, click the edit (pencil) icon in the  upper right corner. It is next to the delete (trash) icon. When you arrive at the Navigation tab after saving changes or from the main site edit page, the navigation items should be collapsed. Open each by clicking the edit (pencil) icon.
...
## Delete links
To delete a link from the navigation, click the delete (trash can) icon and then click "Save". If you click the delete icon by accident, you can click the undo (back looped arrow) icon. Be sure to click "Save" to cancel the deletion.
...
Deleting a parent block from the navigation will also delete any child blocks. This is shown in the interface by all the child blocks also becoming highlighted in red. 

![Parent and child block marked for deletion](sitesfiles/sitenav_del2.png) 

In this image, the delete icon for "Adaptations" has been clicked. "Adaptations" and its child page "Sense and Sensibility" are both shown in red. "Adaptations" now shows the undo button where the trash can used to be. 
