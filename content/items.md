...
![Basic view of admin items page, showing a handful of item resources]({{site.url}}{{site.baseurl}}/content/contentfiles/items_browse.png)
...
In the center top is a button for [Advanced Search]({{site.url}}{{site.baseurl}}/search.md). 
...
![Item browse view with details open for Case of Identity. Links to item view page squared in blue]({{site.url}}{{site.baseurl}}/content/contentfiles/items_detailview.png) The blue squares indicate where to click to open the full item view.
...
![Item view for Case of Identity, showing linked resources]({{site.url}}{{site.baseurl}}/content/contentfiles/items_linked.png) 
...
![Basic view of add items page, with no content entered]({{site.url}}{{site.baseurl}}/content/contentfiles/items_add1.png)
...
![image of text input field with keyboard icon indicating text input, the globe icon for setting language, and a trashcan delete icon]({{site.url}}{{site.baseurl}}/content/contentfiles/items_textedit.png)
...
![Select Item menu with list of items to link in edit item view]({{site.url}}{{site.baseurl}}/content/contentfiles/items_addresource.png)
...
![A blue outline of a rectangle highlights resource options for Items, Item sets, and Media to be used as the input for the element "Description"]({{site.url}}{{site.baseurl}}/content/contentfiles/items_addmediaresource.png)
...
![Focus on the editing portion of a window for the item "Sense and Sensibility", with the elements Title and Description visible. On the right side of the window, a vertical rectangle (the drawer) is open on the right displaying five media which are attached to the item, including video, images, and text.]({{site.url}}{{site.baseurl}}/content/contentfiles/items_mediaresource1.png)

![The same window as before, but now the drawer on the right displays a thumbnail of the media "Sense and Sensibility DVD Trailer" with a dark gray button labeled "select resource" at the bottom of the drawer area.]({{site.url}}{{site.baseurl}}/content/contentfiles/items_mediaresource2.png)
...
![Red arrow points to the globe icon and a text entry field highlighted in blue]({{site.url}}{{site.baseurl}}/content/contentfiles/item_lang.png)
...
![“Add new media” dropdown showing the options]({{site.url}}{{site.baseurl}}/content/contentfiles/items_mediaadd2.png)
...
![Blank media instance blocks all six media types]({{site.url}}{{site.baseurl}}/content/contentfiles/items_mediablocks.png)
...
![Media tab of an item being edited, with the view, edit, and delete buttons to the right of the media file name]({{site.url}}{{site.baseurl}}/content/contentfiles/items_mediaedit.png)
...
![item set tab with one item set added]({{site.url}}{{site.baseurl}}/content/contentfiles/items_itemset.png)
